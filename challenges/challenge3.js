 ...
 * I think it is different in that await means that the computer will wait until the action
 * called has finished running before moving on. Return type is a string
 * 
 * 
